...
import { APPEARANCE_STORAGE_KEY } from './appearanceConfig';
...
function readAppearance(): Appearance {
  ...
  } catch { /* System appearance remains usable when storage is unavailable. */ }
  return 'system';
}

let memoryAppearance: Appearance | null = null;
function snapshot() { return memoryAppearance ?? readAppearance(); }
function serverSnapshot(): Appearance { return 'system'; }
