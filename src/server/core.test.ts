...
describe('native notification boundaries', () => {
  ...
  it('keeps delivery estimates in transit notifications and marks changes', () => {
  ...
  it('localizes native estimates and preserves them before a long location', () => {
    const now = Date.UTC(2026, 7, 25, 12);
...
describe('Amazon Logistics addition policy', () => {
  ...
  it('rejects manually selected Amazon Logistics and carrier changes', () => {
