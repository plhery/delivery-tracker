...
const en = {
  ...
  'attention.not_announced': 'Still not announced after two days',
  ...
  'add.paste': 'Paste',
  'add.pasteFailed': 'Clipboard text could not be pasted.',
  ...
  'add.requirement.trackingUrlHelp':
    'Paste the complete carrier link, including all access parameters.',
  'add.requirement.dpdPostcodeHelp':
    'Used only to verify and retrieve tracking updates from the carrier.',
  'add.confirmCarrier': 'This number format could belong to {{carriers}}. Choose the carrier to confirm.',
  'add.unknownCarrier': 'Carrier not identified. Automatic updates are unavailable. Paste the carrier link or choose the carrier in parcel details.',
  'add.internationalPost': 'International Post means we recognised a postal tracking number but could not identify the carrier. Automatic updates are unavailable. Change the carrier or use the tracking link.',
  'add.autoSync': '{{carrier}} will sync automatically.',
  'add.linkSync': 'Automatic updates are unavailable for {{carrier}}. Use the tracking link to check delivery.',
  'add.failed': 'Could not add the parcel',
  'add.adding': 'Adding…',
  'add.alreadyExists': 'This tracking number is already in your delivery box.',
  ...
  'detail.changeCarrierDescription': 'Choose the carrier for {{number}}. Existing tracking history will be cleared before a fresh check.',
  'detail.saveCarrier': 'Save carrier',
  'detail.changingCarrier': 'Changing…',
  'detail.changeCarrierFailed': 'Could not change the parcel carrier',
  ...
  'sync.queued': 'Tracking check queued…',
  'sync.running': 'Checking with the carrier…',
  'sync.completed': 'Tracking check complete.',
  ...
  'detail.notificationsDescription': 'Receive push notifications for this parcel on every device.',
...
const de: Messages = {
  ...
  'sync.queued': 'Sendungsabfrage geplant…',
  'sync.running': 'Sendung wird beim Transporteur geprüft…',
  'sync.completed': 'Sendungsabfrage abgeschlossen.',
  ...
  'add.paste': 'Einfügen', 'add.pasteFailed': 'Der Text aus der Zwischenablage konnte nicht eingefügt werden.',
  ...
  'add.requirement.trackingUrlHelp': 'Füge den vollständigen Anbieterlink mit allen Zugriffsparametern ein.',
  'add.requirement.dpdPostcodeHelp': 'Wird nur verwendet, um Sendungsaktualisierungen beim Anbieter zu prüfen und abzurufen.',
  'add.confirmCarrier': 'Dieses Nummernformat könnte zu {{carriers}} gehören. Wähle den Anbieter zur Bestätigung.',
  'add.unknownCarrier': 'Anbieter nicht erkannt. Automatische Updates sind nicht verfügbar. Füge den Anbieterlink ein oder wähle den Anbieter in den Paketdetails.',
  'add.internationalPost': 'International Post bedeutet, dass eine Post-Sendungsnummer erkannt wurde, aber kein Anbieter. Automatische Updates sind nicht verfügbar. Ändere den Anbieter oder nutze den Tracking-Link.',
  'add.autoSync': '{{carrier}} wird automatisch synchronisiert.',
  'add.linkSync': 'Automatische Updates sind für {{carrier}} nicht verfügbar. Prüfe die Lieferung über den Tracking-Link.',
  'add.failed': 'Das Paket konnte nicht hinzugefügt werden', 'add.adding': 'Wird hinzugefügt…',
  'add.alreadyExists': 'Diese Sendungsnummer befindet sich bereits in deiner Paketbox.', 'add.openExisting': 'Vorhandenes Paket öffnen',
  ...
  'detail.changeCarrierDescription': 'Wähle den Anbieter für {{number}}. Der bisherige Sendungsverlauf wird vor einer neuen Abfrage gelöscht.',
  'detail.saveCarrier': 'Anbieter speichern', 'detail.changingCarrier': 'Wird geändert…', 'detail.changeCarrierFailed': 'Der Paketanbieter konnte nicht geändert werden',
  ...
  'detail.notifications': 'Paketmeldungen', 'detail.notificationsDescription': 'Erhalte auf jedem Gerät Push-Mitteilungen zu diesem Paket.', 'detail.mute': 'Dieses Paket stummschalten', 'detail.unmute': 'Paketmeldungen einschalten',
...
const fr: Messages = {
  ...
  'sync.queued': 'Vérification du suivi planifiée…',
  'sync.running': 'Vérification auprès du transporteur…',
  'sync.completed': 'Vérification du suivi terminée.',
  ...
  'add.paste': 'Coller', 'add.pasteFailed': 'Le texte du presse-papiers n’a pas pu être collé.',
  ...
  'add.requirement.trackingUrlHelp': 'Collez le lien complet du transporteur, avec tous ses paramètres d’accès.',
  'add.requirement.dpdPostcodeHelp': 'Utilisé uniquement pour vérifier et récupérer les mises à jour auprès du transporteur.',
  'add.confirmCarrier': 'Ce format pourrait appartenir à {{carriers}}. Choisissez le transporteur pour confirmer.',
  'add.unknownCarrier': 'Transporteur non identifié. Les mises à jour automatiques sont indisponibles. Collez le lien du transporteur ou choisissez-le dans les détails du colis.',
  'add.internationalPost': 'International Post signifie qu’un numéro de suivi postal a été reconnu, mais pas le transporteur. Les mises à jour automatiques sont indisponibles. Changez de transporteur ou utilisez le lien de suivi.',
  'add.autoSync': '{{carrier}} sera synchronisé automatiquement.',
  'add.linkSync': 'Les mises à jour automatiques sont indisponibles pour {{carrier}}. Consultez la livraison via le lien de suivi.',
  'add.failed': 'Impossible d’ajouter le colis', 'add.adding': 'Ajout…',
  'add.alreadyExists': 'Ce numéro de suivi est déjà dans votre boîte de livraison.', 'add.openExisting': 'Ouvrir le colis existant',
  ...
  'detail.changeCarrierDescription': 'Choisissez le transporteur de {{number}}. L’ancien historique sera effacé avant une nouvelle vérification.',
  'detail.saveCarrier': 'Enregistrer', 'detail.changingCarrier': 'Modification…', 'detail.changeCarrierFailed': 'Impossible de changer le transporteur du colis',
  ...
  'detail.notifications': 'Alertes du colis', 'detail.notificationsDescription': 'Recevez des notifications push pour ce colis sur tous vos appareils.', 'detail.mute': 'Mettre ce colis en sourdine', 'detail.unmute': 'Réactiver les alertes du colis',
...
const it: Messages = {
  ...
  'sync.queued': 'Controllo del tracking in coda…',
  'sync.running': 'Verifica presso il corriere…',
  'sync.completed': 'Controllo del tracking completato.',
  ...
  'add.paste': 'Incolla', 'add.pasteFailed': 'Non è stato possibile incollare il testo dagli appunti.',
  ...
  'add.requirement.trackingUrlHelp': 'Incolla il link completo del corriere, inclusi tutti i parametri di accesso.',
  'add.requirement.dpdPostcodeHelp': 'Usato solo per verificare e recuperare gli aggiornamenti dal corriere.',
  'add.confirmCarrier': 'Questo formato potrebbe appartenere a {{carriers}}. Scegli il corriere per confermare.',
  'add.unknownCarrier': 'Corriere non identificato. Gli aggiornamenti automatici non sono disponibili. Incolla il link del corriere o sceglilo nei dettagli del pacco.',
  'add.internationalPost': 'International Post indica un numero di tracciamento postale riconosciuto, ma nessun corriere identificato. Gli aggiornamenti automatici non sono disponibili. Cambia corriere o usa il link di tracciamento.',
  'add.autoSync': '{{carrier}} verrà sincronizzato automaticamente.',
  'add.linkSync': 'Gli aggiornamenti automatici non sono disponibili per {{carrier}}. Controlla la consegna tramite il link di tracciamento.',
  'add.failed': 'Impossibile aggiungere il pacco', 'add.adding': 'Aggiunta…',
  'add.alreadyExists': 'Questo numero di tracciamento è già presente nella tua casella consegne.', 'add.openExisting': 'Apri il pacco esistente',
  ...
  'detail.changeCarrierDescription': 'Scegli il corriere per {{number}}. La cronologia precedente verrà cancellata prima di un nuovo controllo.',
  'detail.saveCarrier': 'Salva corriere', 'detail.changingCarrier': 'Modifica…', 'detail.changeCarrierFailed': 'Impossibile cambiare il corriere del pacco',
  ...
  'detail.notifications': 'Avvisi del pacco', 'detail.notificationsDescription': 'Ricevi notifiche push per questo pacco su ogni dispositivo.', 'detail.mute': 'Silenzia questo pacco', 'detail.unmute': 'Riattiva gli avvisi del pacco',
