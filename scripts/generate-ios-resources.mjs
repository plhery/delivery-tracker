...
const nativeMessages = {
  en: {
    ...
    'native.error.rateLimited': 'Too many requests. Try again shortly.',
    ...
    'widget.settingDescription': 'Share out-for-delivery and next-up parcel details with Home Screen widgets you add.',
  ...
  de: {
    ...
    'native.error.rateLimited': 'Zu viele Anfragen. Bitte versuche es in Kürze erneut.',
    ...
    'widget.settingDescription': 'Teile Details zu Paketen in Zustellung und zur nächsten Sendung mit hinzugefügten Home-Bildschirm-Widgets.',
  ...
  fr: {
    ...
    'native.error.rateLimited': 'Trop de requêtes. Réessayez dans quelques instants.',
    ...
    'widget.settingDescription': 'Partagez les détails des colis en livraison et du prochain colis avec les widgets d’écran d’accueil que vous ajoutez.',
  ...
  it: {
    ...
    'native.error.rateLimited': 'Troppe richieste. Riprova tra poco.',
    ...
    'widget.settingDescription': 'Condividi i dettagli dei pacchi in consegna e del prossimo pacco con i widget della schermata Home che aggiungi.',
