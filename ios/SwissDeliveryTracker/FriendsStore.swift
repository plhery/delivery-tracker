...
extension FriendStamp {
    ...
    var explanationKey: String {
        switch self { case .first: "passport.firstExplanation"; case .ten: "passport.tenExplanation"; case .connected: "passport.carrierExplanation"; case .express: "passport.expressExplanation"; case .acrossBorders: "passport.acrossExplanation"; case .aroundWorld: "passport.aroundExplanation"; case .theRegular: "passport.regularExplanation"; case .rightNextDoor: "passport.domesticExplanation"; case .worthTheWait: "passport.waitExplanation"; case .busyDoorstep: "passport.busyExplanation"; case .pickedUp: "passport.pickupExplanation"; case .homeForHolidays: "passport.holidayExplanation" }
    }
    var symbol: String {
