...
| [Postal Ninja](postal-ninja/README.md) | Alternative aggregator with verified TRAWL/Camoufox retrieval | Browser verification and latency; widget returns first/latest scans; direct HTTP remains challenged | Opt-in before 17TRACK |
