-- Separate confirmed public Amazon Shipping deliveries from account-based Amazon Logistics.
  ...
  add constraint packages_carrier_check
    check (
      carrier in (
        ...
        'dachser', 'dhl', 'dhl-ecommerce', 'ups', 'amazon-logistics', 'amazon-shipping', 'fedex', 'gls-ch',
