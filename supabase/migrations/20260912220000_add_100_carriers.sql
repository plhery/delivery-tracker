-- Register 65 universal-fallback carriers for initial number detection.
-- They use the universal adapter (ParcelsApp/17TRACK/Ship24); no dedicated scraper yet.
-- Preserve the current quota, ownership, barcode and carrier-history behavior.
  ...
  add constraint packages_carrier_check
    check (
      carrier in (
        ...
        'ecoscooting', 'estafeta', 'evri', 'four-px',
