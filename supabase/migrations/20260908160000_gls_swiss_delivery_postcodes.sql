-- GLS Germany also delivers to Swiss postcodes. Preserve existing validation,
-- ownership, quotas and tracking-reset behavior when creating or editing parcels.
...
alter table public.packages
  ...
  add constraint packages_dpd_postcode_check
    check (
      ...
      or (carrier in ('heppner', 'gls-de') and dpd_postcode ~ '^[0-9]{4,5}$')
      or (
        carrier = 'paack'
